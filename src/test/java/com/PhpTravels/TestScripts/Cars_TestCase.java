...
import com.PhpTravels.pom.CarsBooking_Object;
import com.PhpTravels.pom.CarsFilter_and_Confirm_Object;
...
public class Cars_TestCase {
	...
	CarsBooking_Object carsbooking;
	CarsFilter_and_Confirm_Object carsfilter;
	...
	public void openBrowser() {
		...
		carsbooking = PageFactory.initElements(driver, CarsBooking_Object.class);
		carsfilter = PageFactory.initElements(driver, CarsFilter_and_Confirm_Object.class);
	}
