...
public class Hotel_Invalid_Date extends Waits {
	...
	@FindBy(xpath = "//div[@class='datepicker dropdown-menu'][2]/div[1]/table/tbody/tr[5]/td[contains(text(),27) and @class='day disabled']")
	public WebElement checkout_Date_Disbaled;
